...
export const uiRecipes = {
  ...
  contentKindBadge:
    'inline-flex w-fit items-center rounded-md border border-dashed border-site-line-strong bg-site-card px-2.5 py-1 [font-family:var(--cad-font-hand)] text-(--cad-hand-xs) font-semibold uppercase tracking-widest text-site-ink-subtle lg:px-3',
  controlButton:
    'inline-flex items-center justify-center rounded-md border border-dashed border-site-line-strong bg-site-panel [font-family:var(--cad-font-hand)] text-site-ink transition-colors duration-150 hover:bg-site-hover hover:text-site-link-hover focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-dashed focus-visible:outline-site-link-hover',
  dropdownMenu:
